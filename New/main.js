...
$(function() {
  ...
  function init_more_intro() {
      ...
      $('#submit_more_intro').on('click', function () {
          ...
          if (not_alphanumeric(stmajor) || not_alphanumeric(attribute1) || not_alphanumeric(attribute2) || not_alphanumeric(attribute3) || not_alphanumeric(attribute4)) {
              error = 1;
              errormsg = 'Please enter letters/numbers only';   //Apurva
          }
  ...
  function init_task() {
      ...
      function usercomments() {
          ...
          setTimeout(function () {
              ...
              $('Georgeee commented "Hello! nice to meet you"').fadeIn(25000).delay(200000).fadeOut(225000);
          }, 25000);
 ...
 //  }
  ...
  function get_params() {
    ...
    // window.redirect = "./survey.html";
    //window.redirect = $('#survey2').show();
	}
