...
$(function() {
  ...
  function init_more_intro() {
      ...
      $('#submit_more_intro').on('click', function () {
          ...
          if (not_alpha(stmajor) || not_alpha(attribute1) || not_alpha(attribute2) || not_alpha(attribute3) || not_alpha(attribute4)) {
              error = 1;
